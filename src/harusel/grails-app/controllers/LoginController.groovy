 ...
 */
// CR: major dkranchev 02-Mar-2010 Cleanup unused code. 
class LoginController {
    ...
    def auth = {
        ...
        // CR: normal dkranchev 02-Mar-2010 Is facebook and openid auth work? If not then remove unused code.
        String view
        String postUrl
    ...
    def authfail = {
        ...
        if (exception) {
            if (exception instanceof DisabledException) {
                msg = message(code: "login.user.disabled", args: [username])
            }
            else {
                msg = message(code: "login.user.bad.password", args: [username])
            }
        }
    ...
    /**
     * Sings out and redirects to auth action.
     */
    def signout = {
        SCH.clearContext()
